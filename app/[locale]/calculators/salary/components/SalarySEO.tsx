  ...
  return (
    <div className="bg-white dark:bg-dark-surface rounded-2xl border border-gray-200 dark:border-gray-700 p-6 sm:p-8">
      ...
      <div className="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 space-y-5 text-sm leading-relaxed">
        ...
        <h3 className="text-lg font-bold text-gray-800 dark:text-white">سلالم الرواتب الحكومية في السعودية</h3>
        <p>
          تعتمد المملكة العربية السعودية عدة سلالم رواتب للقطاعات الحكومية المختلفة، كل منها يتكون من مراتب ودرجات بعلاوات سنوية ثابتة:
        </p>
        <ul className="list-disc pr-6 space-y-1">
          <li><strong>سلم الموظفين العام:</strong> 15 مرتبة (3,000 - 28,640 ريال) للخدمة المدنية، بدل نقل 500-1,200 ريال.</li>
          <li><strong>سلم المعلمين:</strong> 4 فئات (معلم، ممارس، متقدم، خبير) تبدأ من 5,200 وتصل إلى 22,570 ريال.</li>
          <li><strong>سلم القطاع الصحي:</strong> الأعلى رواتب — الطبيب الاستشاري يصل إلى 39,000+ ريال، الفني يبدأ من 4,670 ريال.</li>
          <li><strong>سلم العسكريين (ضباط):</strong> من الملازم (7,590 ريال) إلى اللواء (28,690 ريال) مع بدلات إضافية.</li>
          <li><strong>سلم العسكريين (أفراد):</strong> من الجندي (3,220 ريال) إلى رئيس الرقباء (12,255 ريال).</li>
        </ul>
        <p>
          يمكنك استخدام أداة <strong>سلالم الرواتب الحكومية</strong> أعلاه لمعرفة راتبك بالضبط حسب المرتبة والدرجة، ومقارنة الرواتب بين القطاعات المختلفة.
        </p>

        <h3 className="text-lg font-bold text-gray-800 dark:text-white">مقارنة الرواتب بين القطاعات</h3>
        <p>
          عند اختيار مجال العمل الحكومي، من المهم مقارنة الرواتب والمزايا:
        </p>
        <div className="bg-teal-50 dark:bg-teal-900/10 rounded-xl p-4 not-prose">
          <div className="space-y-2 text-xs text-teal-700 dark:text-teal-400">
            <p>• <strong>أعلى راتب مبتدئ:</strong> القطاع العسكري (ضباط) — 7,590 ريال</p>
            <p>• <strong>أعلى سقف راتب:</strong> القطاع الصحي — 39,000+ ريال</p>
            <p>• <strong>أعلى بدل نقل:</strong> الخدمة المدنية (المرتبة 14) — 1,200 ريال</p>
            <p>• <strong>أسرع نمو:</strong> القطاع الصحي مع علاوات سنوية تصل إلى 1,110 ريال</p>
          </div>
        </div>
