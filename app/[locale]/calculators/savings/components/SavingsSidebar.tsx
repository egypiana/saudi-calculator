  ...
  return (
    <aside className="space-y-6 sticky top-24">
      ...
      <div className="bg-white dark:bg-dark-surface rounded-2xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm">
        ...
        <Link href={lp(locale, "/blog")} className="mt-4 block text-center text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 transition-colors">تصفح جميع المقالات &larr;</Link>
      </div>
    </aside>
  );
}
