...
const RELATED_COUNTDOWNS = [
  ...
  { title: "عداد ليلة القدر", href: "/countdowns/laylatul-qadr", icon: "✨", date: "2027-03-04" },
  { title: "عداد عيد الأضحى", href: "/countdowns/eid-adha", icon: "🐑", date: "2026-06-07" },
  { title: "عداد موسم الحج", href: "/countdowns/hajj", icon: "🕋", date: "2026-06-01" },
];

const RELATED_CALCULATORS = [
  { title: "حاسبة زكاة الفطر", href: "/calculators/zakat", icon: "💰", desc: "احسب زكاتك بدقة" },
...
const ALL_ARTICLES = [
  { title: "آداب صلاة عيد الفطر وأحكامها", category: "إسلامي", readTime: 4, href: "/blog/eid-prayer" },
  { title: "كيف تحسب زكاة الفطر بسهولة", category: "مالي", readTime: 3, href: "/blog/zakat-fitr" },
  { title: "نصائح لادخار مال العيد", category: "مالي", readTime: 4, href: "/blog/eid-savings" },
  { title: "فضل شهر رمضان وأعمال آخره", category: "إسلامي", readTime: 5, href: "/blog/ramadan-virtues" },
  { title: "أفضل وجبات إفطار العيد", category: "أسري", readTime: 6, href: "/blog/eid-food" },
  { title: "كيف تخطط ميزانيتك بقاعدة 50/30/20", category: "مالي", readTime: 6, href: "/blog/budget-rule" },
  { title: "تقاليد العيد في المملكة العربية السعودية", category: "ثقافي", readTime: 5, href: "/blog/eid-traditions" },
  { title: "دليل حساب زكاة المال والذهب", category: "مالي", readTime: 7, href: "/blog/zakat-guide" },
];
...
export default function EidSidebar({ locale }: EidSidebarProps) {
