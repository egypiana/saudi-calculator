      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8" dir="rtl">
        ...
        <div className="mt-6 mb-8">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-3">
            {isAr ? "جميع مواعيد عيد الأضحى" : "All Eid Al-Adha Dates"}
          </h1>
          <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed max-w-3xl">
            {isAr
              ? "تصفح مواعيد عيد الأضحى المبارك من 2025 حتى 2050 — تواريخ دقيقة وعدادات تنازلية لكل عام."
              : "Browse Eid Al-Adha dates from 2025 to 2050 — accurate dates and countdown timers."}
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-[3fr_1fr] gap-6">
          <EidAdhaYearsClient locale={locale} />
